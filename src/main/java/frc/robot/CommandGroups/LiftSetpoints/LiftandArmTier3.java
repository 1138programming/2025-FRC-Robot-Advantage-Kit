...
public class LiftandArmTier3 extends ParallelCommandGroup {
  /** Creates a new LiftandArmTier3. */
  public LiftandArmTier3(Arm arm, Lift lift) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        new TiltArmToSetPosition(arm, KArmPositionReefL3),
        new MoveLiftToPos(lift, KLiftPositionReefL3));
  }
}
